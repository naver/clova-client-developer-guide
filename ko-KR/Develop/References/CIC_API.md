...
| 401 Unauthorized          | 사용자 인증에 실패했을 때 발생하는 오류입니다. 이때 [사용자 인증](/Develop/Guides/Interact_with_CIC.md#ObtainCLOVAAccessToken)을 다시 시도해야합니다.                       |
...
| 401 Unauthorized          | 사용자 인증에 실패했을 때 이 상태 코드가 반환됩니다. 이때 [사용자 인증](/Develop/Guides/Interact_with_CIC.md#ObtainCLOVAAccessToken)을 다시 시도해야합니다.                        |
...
| 401     | 사용자 인증에 실패했을 때 발생하는 오류입니다. 이때 [사용자 인증](/Develop/Guides/Interact_with_CIC.md#ObtainCLOVAAccessToken)을 다시 시도해야합니다. |
| 500     | 서버 내부 오류입니다.                                                                                |
